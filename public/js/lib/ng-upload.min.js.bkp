...
angular.module('ngUpload', [])
    .directive('uploadSubmit', ['$parse', function($parse) {
        ...
        function getParentNodeByTagName(element, tagName) {
            ...
            if ( typeof parent[0] != 'undefined' && parent[0].tagName.toLowerCase() === tagName ) {
                return parent;
            } else {
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                element.bind('click', function($event) {
                    ...
                    form[0].submit();
                    if (attrs.hasOwnProperty( "submitClr" ) ) {
                        $(form).trigger('reset');
                    }
    ...
    .directive('ngUpload', ['$parse', '$document', function ($parse, $document) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                // this has been commented out - make sure authenticity tokens are included manually!!!!
